import { classPrivateFieldGet as _classPrivateFieldGet } from '../../_virtual/_rollupPluginBabelHelpers.js';
import { objectExpression, objectMethod, stringLiteral, program, importDeclaration, importSpecifier, variableDeclaration, variableDeclarator, exportDefaultDeclaration, functionDeclaration, blockStatement, tryStatement, expressionStatement, callExpression, arrowFunctionExpression, nullLiteral, identifier, newExpression } from '../ast/builders.mjs';
